...
trigger: glob
globs: "app/workers/**/*"
description: "Pilgrim service: celery-scheduler — segment 1/1. Mirrors .cursor/rules/celery-scheduler.mdc."
---

# Pilgrim — celery scheduler

> Antigravity workspace rule. Canonical copy: `.cursor/rules/celery-scheduler.mdc`.
