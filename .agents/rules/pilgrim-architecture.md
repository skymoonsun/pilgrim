---
trigger: always_on
description: "Pilgrim service: architecture — segment 1/1. Mirrors .cursor/rules/architecture.mdc."
---

# Pilgrim — architecture

> Antigravity workspace rule. Canonical copy: `.cursor/rules/architecture.mdc`.
