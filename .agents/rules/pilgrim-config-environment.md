...
trigger: glob
globs: "app/core/**/*.py"
description: "Pilgrim service: config-environment — segment 1/1. Mirrors .cursor/rules/config-environment.mdc."
---

# Pilgrim — config environment

> Antigravity workspace rule. Canonical copy: `.cursor/rules/config-environment.mdc`.
